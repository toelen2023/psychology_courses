...
class PC_Loader {
    ...
    private function load_files(): void {
        ...
        require_once PC_PLUGIN_PATH . 'includes/shortcodes/class-schedule-main-shortcode.php';
        //teachers
